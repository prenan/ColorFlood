 ...
 * \brief Propage la couleur choisie sur la composante connexe à partir d'une case de départ (généralement la case (0, 0)).
 *
 ...
 *
 * \param plateau Grille que l'on souhaite copier
 * \param size Taille du jeu (grille size*size)
